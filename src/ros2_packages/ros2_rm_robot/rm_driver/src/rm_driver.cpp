...
void RmArm::Arm_Movep_CANFD_Callback(rm_ros_interfaces::msg::Cartepos::SharedPtr msg)
{
    ...
    pose.euler.ry = tarns_euler.ry;
    pose.euler.rz = tarns_euler.rz;
    pose.quaternion.w = msg->pose.orientation.w;
    pose.quaternion.x = msg->pose.orientation.x;
    pose.quaternion.y = msg->pose.orientation.y;
    pose.quaternion.z = msg->pose.orientation.z;
    follow = msg->follow;
    trajectory_mode = trajectory_mode_;
    radio = radio_;
