...
static rosidl_typesupport_introspection_c__MessageMember rm_ros_interfaces__msg__Armoriginalstate__rosidl_typesupport_introspection_c__Armoriginalstate_message_member_array[5] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_ros_interfaces__msg__Armoriginalstate, err),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_ros_interfaces__msg__Armoriginalstate, err_len),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
