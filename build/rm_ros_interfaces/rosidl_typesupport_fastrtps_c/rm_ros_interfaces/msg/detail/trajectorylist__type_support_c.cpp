...
#include "rm_ros_interfaces/msg/detail/trajectorylist__rosidl_typesupport_fastrtps_c.h"
...
#include "rm_ros_interfaces/msg/detail/trajectoryinfo__functions.h"  // tra_list
...
using _Trajectorylist__ros_msg_type = rm_ros_interfaces__msg__Trajectorylist;
  ...
  // Field name: tra_list
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, rm_ros_interfaces, msg, Trajectoryinfo
      )()->data);
    size_t size = ros_message->tra_list.size;
    auto array_ptr = ros_message->tra_list.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: tra_list
  {
    ...
    if (ros_message->tra_list.data) {
      rm_ros_interfaces__msg__Trajectoryinfo__Sequence__fini(&ros_message->tra_list);
    }
    if (!rm_ros_interfaces__msg__Trajectoryinfo__Sequence__init(&ros_message->tra_list, size)) {
      fprintf(stderr, "failed to create array for field 'tra_list'");
      return false;
    }
    auto array_ptr = ros_message->tra_list.data;
    for (size_t i = 0; i < size; ++i) {
...
size_t get_serialized_size_rm_ros_interfaces__msg__Trajectorylist(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Trajectorylist__ros_msg_type * ros_message = static_cast<const _Trajectorylist__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name tra_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_rm_ros_interfaces__msg__Trajectoryinfo(
...
static uint32_t _Trajectorylist__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rm_ros_interfaces__msg__Trajectorylist(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_ros_interfaces
size_t max_serialized_size_rm_ros_interfaces__msg__Trajectorylist(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: tra_list
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_rm_ros_interfaces__msg__Trajectoryinfo(
  ...
  if (is_plain) {
    ...
    using DataType = rm_ros_interfaces__msg__Trajectorylist;
    is_plain =
      (
...
static size_t _Trajectorylist__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rm_ros_interfaces__msg__Trajectorylist(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_ros_interfaces, msg, Trajectorylist)() {
