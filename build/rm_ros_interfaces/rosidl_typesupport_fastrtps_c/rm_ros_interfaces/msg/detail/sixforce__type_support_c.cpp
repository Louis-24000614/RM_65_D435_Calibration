...
#include "rm_ros_interfaces/msg/detail/sixforce__rosidl_typesupport_fastrtps_c.h"
...
using _Sixforce__ros_msg_type = rm_ros_interfaces__msg__Sixforce;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Sixforce__ros_msg_type * ros_message = static_cast<const _Sixforce__ros_msg_type *>(untyped_ros_message);
  // Field name: force_fx
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Sixforce__ros_msg_type * ros_message = static_cast<_Sixforce__ros_msg_type *>(untyped_ros_message);
  // Field name: force_fx
  {
    cdr >> ros_message->force_fx;
  }
...
size_t get_serialized_size_rm_ros_interfaces__msg__Sixforce(
  const void * untyped_ros_message,
...
static uint32_t _Sixforce__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rm_ros_interfaces__msg__Sixforce(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_ros_interfaces
size_t max_serialized_size_rm_ros_interfaces__msg__Sixforce(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_ros_interfaces__msg__Sixforce;
    is_plain =
      (
...
static size_t _Sixforce__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rm_ros_interfaces__msg__Sixforce(
...
static message_type_support_callbacks_t __callbacks_Sixforce = {
...
static rosidl_message_type_support_t _Sixforce__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Sixforce,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_ros_interfaces, msg, Sixforce)() {
  return &_Sixforce__type_support;
}
