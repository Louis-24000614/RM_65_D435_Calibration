...
#include "rm_ros_interfaces/msg/detail/robot_info__rosidl_typesupport_fastrtps_c.h"
...
using _RobotInfo__ros_msg_type = rm_ros_interfaces__msg__RobotInfo;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: arm_dof
  {
    cdr << ros_message->arm_dof;
  }

  // Field name: arm_model
  {
    cdr << ros_message->arm_model;
  }

  // Field name: force_type
  {
    cdr << ros_message->force_type;
  }

  // Field name: robot_controller_version
  {
    cdr << ros_message->robot_controller_version;
  }
...
size_t get_serialized_size_rm_ros_interfaces__msg__RobotInfo(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name arm_dof
  {
    size_t item_size = sizeof(ros_message->arm_dof);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name arm_model
  {
    size_t item_size = sizeof(ros_message->arm_model);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name force_type
  {
    size_t item_size = sizeof(ros_message->force_type);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name robot_controller_version
  {
    size_t item_size = sizeof(ros_message->robot_controller_version);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name state
...
static uint32_t _RobotInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rm_ros_interfaces__msg__RobotInfo(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_ros_interfaces
size_t max_serialized_size_rm_ros_interfaces__msg__RobotInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_ros_interfaces__msg__RobotInfo;
    is_plain =
      (
...
static size_t _RobotInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rm_ros_interfaces__msg__RobotInfo(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_ros_interfaces, msg, RobotInfo)() {
