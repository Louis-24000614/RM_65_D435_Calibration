...
#include "rm_ros_interfaces/msg/detail/jointpos__rosidl_typesupport_fastrtps_c.h"
...
using _Jointpos__ros_msg_type = rm_ros_interfaces__msg__Jointpos;
...
size_t get_serialized_size_rm_ros_interfaces__msg__Jointpos(
  const void * untyped_ros_message,
...
static uint32_t _Jointpos__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rm_ros_interfaces__msg__Jointpos(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_ros_interfaces
size_t max_serialized_size_rm_ros_interfaces__msg__Jointpos(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_ros_interfaces__msg__Jointpos;
    is_plain =
      (
...
static size_t _Jointpos__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rm_ros_interfaces__msg__Jointpos(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_ros_interfaces, msg, Jointpos)() {
