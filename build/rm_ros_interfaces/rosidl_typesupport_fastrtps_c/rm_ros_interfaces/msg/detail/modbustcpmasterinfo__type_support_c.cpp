...
#include "rm_ros_interfaces/msg/detail/modbustcpmasterinfo__rosidl_typesupport_fastrtps_c.h"
...
using _Modbustcpmasterinfo__ros_msg_type = rm_ros_interfaces__msg__Modbustcpmasterinfo;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Modbustcpmasterinfo__ros_msg_type * ros_message = static_cast<const _Modbustcpmasterinfo__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _Modbustcpmasterinfo__ros_msg_type * ros_message = static_cast<_Modbustcpmasterinfo__ros_msg_type *>(untyped_ros_message);
  // Field name: master_name
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _Modbustcpmasterinfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rm_ros_interfaces__msg__Modbustcpmasterinfo(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_ros_interfaces__msg__Modbustcpmasterinfo;
    is_plain =
      (
...
static size_t _Modbustcpmasterinfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rm_ros_interfaces__msg__Modbustcpmasterinfo(
...
static message_type_support_callbacks_t __callbacks_Modbustcpmasterinfo = {
...
static rosidl_message_type_support_t _Modbustcpmasterinfo__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Modbustcpmasterinfo,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_ros_interfaces, msg, Modbustcpmasterinfo)() {
  return &_Modbustcpmasterinfo__type_support;
}
