...
#include "rm_ros_interfaces/msg/detail/movel__rosidl_typesupport_fastrtps_c.h"
...
using _Movel__ros_msg_type = rm_ros_interfaces__msg__Movel;
  ...
  void * untyped_ros_message)
{
  ...
  _Movel__ros_msg_type * ros_message = static_cast<_Movel__ros_msg_type *>(untyped_ros_message);
  // Field name: pose
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_rm_ros_interfaces__msg__Movel(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Movel__ros_msg_type * ros_message = static_cast<const _Movel__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Movel__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rm_ros_interfaces__msg__Movel(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_ros_interfaces
size_t max_serialized_size_rm_ros_interfaces__msg__Movel(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_ros_interfaces__msg__Movel;
    is_plain =
      (
...
static size_t _Movel__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rm_ros_interfaces__msg__Movel(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_ros_interfaces, msg, Movel)() {
