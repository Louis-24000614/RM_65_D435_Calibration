...
#include "rm_ros_interfaces/msg/detail/liftstate__rosidl_typesupport_fastrtps_c.h"
...
using _Liftstate__ros_msg_type = rm_ros_interfaces__msg__Liftstate;
...
size_t get_serialized_size_rm_ros_interfaces__msg__Liftstate(
  const void * untyped_ros_message,
...
static uint32_t _Liftstate__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rm_ros_interfaces__msg__Liftstate(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_ros_interfaces
size_t max_serialized_size_rm_ros_interfaces__msg__Liftstate(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_ros_interfaces__msg__Liftstate;
    is_plain =
      (
...
static size_t _Liftstate__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rm_ros_interfaces__msg__Liftstate(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_ros_interfaces, msg, Liftstate)() {
