...
rm_ros_interfaces__msg__Armcurrentstatus__are_equal(const rm_ros_interfaces__msg__Armcurrentstatus * lhs, const rm_ros_interfaces__msg__Armcurrentstatus * rhs)
{
  ...
  // arm_current_status
  if (lhs->arm_current_status != rhs->arm_current_status) {
    return false;
  }
  return true;
}
  ...
  rm_ros_interfaces__msg__Armcurrentstatus * output)
{
  ...
  // arm_current_status
  output->arm_current_status = input->arm_current_status;
  return true;
}
...
rm_ros_interfaces__msg__Armcurrentstatus__create()
{
  ...
  rm_ros_interfaces__msg__Armcurrentstatus * msg = (rm_ros_interfaces__msg__Armcurrentstatus *)allocator.allocate(sizeof(rm_ros_interfaces__msg__Armcurrentstatus), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rm_ros_interfaces__msg__Armcurrentstatus));
  bool success = rm_ros_interfaces__msg__Armcurrentstatus__init(msg);
  if (!success) {
...
rm_ros_interfaces__msg__Armcurrentstatus__destroy(rm_ros_interfaces__msg__Armcurrentstatus * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    rm_ros_interfaces__msg__Armcurrentstatus__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
rm_ros_interfaces__msg__Armcurrentstatus__Sequence__init(rm_ros_interfaces__msg__Armcurrentstatus__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rm_ros_interfaces__msg__Armcurrentstatus * data = NULL;

  if (size) {
    data = (rm_ros_interfaces__msg__Armcurrentstatus *)allocator.zero_allocate(size, sizeof(rm_ros_interfaces__msg__Armcurrentstatus), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rm_ros_interfaces__msg__Armcurrentstatus__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rm_ros_interfaces__msg__Armcurrentstatus__fini(&data[i - 1]);
      }
...
rm_ros_interfaces__msg__Armcurrentstatus__Sequence__fini(rm_ros_interfaces__msg__Armcurrentstatus__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rm_ros_interfaces__msg__Armcurrentstatus__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rm_ros_interfaces__msg__Armcurrentstatus__Sequence * array = (rm_ros_interfaces__msg__Armcurrentstatus__Sequence *)allocator.allocate(sizeof(rm_ros_interfaces__msg__Armcurrentstatus__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rm_ros_interfaces__msg__Armcurrentstatus__Sequence__init(array, size);
  if (!success) {
...
rm_ros_interfaces__msg__Armcurrentstatus__Sequence__destroy(rm_ros_interfaces__msg__Armcurrentstatus__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rm_ros_interfaces__msg__Armcurrentstatus__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rm_ros_interfaces__msg__Armcurrentstatus__Sequence__are_equal(const rm_ros_interfaces__msg__Armcurrentstatus__Sequence * lhs, const rm_ros_interfaces__msg__Armcurrentstatus__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rm_ros_interfaces__msg__Armcurrentstatus__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rm_ros_interfaces__msg__Armcurrentstatus__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rm_ros_interfaces__msg__Armcurrentstatus);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rm_ros_interfaces__msg__Armcurrentstatus * data =
      (rm_ros_interfaces__msg__Armcurrentstatus *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rm_ros_interfaces__msg__Armcurrentstatus__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rm_ros_interfaces__msg__Armcurrentstatus__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rm_ros_interfaces__msg__Armcurrentstatus__copy(
