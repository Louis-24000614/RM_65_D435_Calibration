...
rm_ros_interfaces__msg__Softwarebuildinfo__init(rm_ros_interfaces__msg__Softwarebuildinfo * msg)
{
  ...
  // build_time
  if (!rosidl_runtime_c__String__init(&msg->build_time)) {
    rm_ros_interfaces__msg__Softwarebuildinfo__fini(msg);
    return false;
  }
  // version
...
rm_ros_interfaces__msg__Softwarebuildinfo__fini(rm_ros_interfaces__msg__Softwarebuildinfo * msg)
{
  ...
  // build_time
  rosidl_runtime_c__String__fini(&msg->build_time);
  // version
  ...
  rm_ros_interfaces__msg__Softwarebuildinfo * output)
{
  ...
  if (!rosidl_runtime_c__String__copy(
      &(input->build_time), &(output->build_time)))
  {
    return false;
  }
  // version
...
rm_ros_interfaces__msg__Softwarebuildinfo__create()
{
  ...
  rm_ros_interfaces__msg__Softwarebuildinfo * msg = (rm_ros_interfaces__msg__Softwarebuildinfo *)allocator.allocate(sizeof(rm_ros_interfaces__msg__Softwarebuildinfo), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rm_ros_interfaces__msg__Softwarebuildinfo));
  bool success = rm_ros_interfaces__msg__Softwarebuildinfo__init(msg);
  if (!success) {
...
rm_ros_interfaces__msg__Softwarebuildinfo__Sequence__init(rm_ros_interfaces__msg__Softwarebuildinfo__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rm_ros_interfaces__msg__Softwarebuildinfo * data = NULL;

  if (size) {
    data = (rm_ros_interfaces__msg__Softwarebuildinfo *)allocator.zero_allocate(size, sizeof(rm_ros_interfaces__msg__Softwarebuildinfo), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rm_ros_interfaces__msg__Softwarebuildinfo__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rm_ros_interfaces__msg__Softwarebuildinfo__fini(&data[i - 1]);
      }
...
rm_ros_interfaces__msg__Softwarebuildinfo__Sequence__fini(rm_ros_interfaces__msg__Softwarebuildinfo__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rm_ros_interfaces__msg__Softwarebuildinfo__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rm_ros_interfaces__msg__Softwarebuildinfo__Sequence * array = (rm_ros_interfaces__msg__Softwarebuildinfo__Sequence *)allocator.allocate(sizeof(rm_ros_interfaces__msg__Softwarebuildinfo__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rm_ros_interfaces__msg__Softwarebuildinfo__Sequence__init(array, size);
  if (!success) {
...
rm_ros_interfaces__msg__Softwarebuildinfo__Sequence__destroy(rm_ros_interfaces__msg__Softwarebuildinfo__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rm_ros_interfaces__msg__Softwarebuildinfo__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rm_ros_interfaces__msg__Softwarebuildinfo__Sequence__are_equal(const rm_ros_interfaces__msg__Softwarebuildinfo__Sequence * lhs, const rm_ros_interfaces__msg__Softwarebuildinfo__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rm_ros_interfaces__msg__Softwarebuildinfo__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rm_ros_interfaces__msg__Softwarebuildinfo__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rm_ros_interfaces__msg__Softwarebuildinfo);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rm_ros_interfaces__msg__Softwarebuildinfo * data =
      (rm_ros_interfaces__msg__Softwarebuildinfo *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rm_ros_interfaces__msg__Softwarebuildinfo__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rm_ros_interfaces__msg__Softwarebuildinfo__fini(&output->data[i]);
        }
        return false;
      }
    }
