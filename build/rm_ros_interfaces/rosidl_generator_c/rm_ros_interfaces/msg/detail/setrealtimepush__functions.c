...
rm_ros_interfaces__msg__Setrealtimepush__are_equal(const rm_ros_interfaces__msg__Setrealtimepush * lhs, const rm_ros_interfaces__msg__Setrealtimepush * rhs)
{
  ...
  // aloha_state_enable
  if (lhs->aloha_state_enable != rhs->aloha_state_enable) {
    return false;
  }
  // arm_current_status_enable
  if (lhs->arm_current_status_enable != rhs->arm_current_status_enable) {
    return false;
  }
  // expand_state_enable
  if (lhs->expand_state_enable != rhs->expand_state_enable) {
    return false;
  }
  // hand_enable
  if (lhs->hand_enable != rhs->hand_enable) {
    return false;
  }
  // joint_speed_enable
  if (lhs->joint_speed_enable != rhs->joint_speed_enable) {
    return false;
  }
  // lift_state_enable
  if (lhs->lift_state_enable != rhs->lift_state_enable) {
    return false;
  }
  // plus_base_enable
  if (lhs->plus_base_enable != rhs->plus_base_enable) {
    return false;
  }
  // plus_state_enable
  if (lhs->plus_state_enable != rhs->plus_state_enable) {
    return false;
  }
  return true;
}
  ...
  rm_ros_interfaces__msg__Setrealtimepush * output)
{
  ...
  // aloha_state_enable
  output->aloha_state_enable = input->aloha_state_enable;
  // arm_current_status_enable
  output->arm_current_status_enable = input->arm_current_status_enable;
  // expand_state_enable
  output->expand_state_enable = input->expand_state_enable;
  // hand_enable
  output->hand_enable = input->hand_enable;
  // joint_speed_enable
  output->joint_speed_enable = input->joint_speed_enable;
  // lift_state_enable
  output->lift_state_enable = input->lift_state_enable;
  // plus_base_enable
  output->plus_base_enable = input->plus_base_enable;
  // plus_state_enable
  output->plus_state_enable = input->plus_state_enable;
  return true;
}
