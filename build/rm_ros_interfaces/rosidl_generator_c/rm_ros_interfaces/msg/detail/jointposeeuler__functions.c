...
rm_ros_interfaces__msg__Jointposeeuler__create()
{
  ...
  rm_ros_interfaces__msg__Jointposeeuler * msg = (rm_ros_interfaces__msg__Jointposeeuler *)allocator.allocate(sizeof(rm_ros_interfaces__msg__Jointposeeuler), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rm_ros_interfaces__msg__Jointposeeuler));
  bool success = rm_ros_interfaces__msg__Jointposeeuler__init(msg);
  if (!success) {
...
rm_ros_interfaces__msg__Jointposeeuler__destroy(rm_ros_interfaces__msg__Jointposeeuler * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    rm_ros_interfaces__msg__Jointposeeuler__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
rm_ros_interfaces__msg__Jointposeeuler__Sequence__init(rm_ros_interfaces__msg__Jointposeeuler__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rm_ros_interfaces__msg__Jointposeeuler * data = NULL;

  if (size) {
    data = (rm_ros_interfaces__msg__Jointposeeuler *)allocator.zero_allocate(size, sizeof(rm_ros_interfaces__msg__Jointposeeuler), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rm_ros_interfaces__msg__Jointposeeuler__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rm_ros_interfaces__msg__Jointposeeuler__fini(&data[i - 1]);
      }
...
rm_ros_interfaces__msg__Jointposeeuler__Sequence__fini(rm_ros_interfaces__msg__Jointposeeuler__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rm_ros_interfaces__msg__Jointposeeuler__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rm_ros_interfaces__msg__Jointposeeuler__Sequence * array = (rm_ros_interfaces__msg__Jointposeeuler__Sequence *)allocator.allocate(sizeof(rm_ros_interfaces__msg__Jointposeeuler__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rm_ros_interfaces__msg__Jointposeeuler__Sequence__init(array, size);
  if (!success) {
...
rm_ros_interfaces__msg__Jointposeeuler__Sequence__destroy(rm_ros_interfaces__msg__Jointposeeuler__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rm_ros_interfaces__msg__Jointposeeuler__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rm_ros_interfaces__msg__Jointposeeuler__Sequence__are_equal(const rm_ros_interfaces__msg__Jointposeeuler__Sequence * lhs, const rm_ros_interfaces__msg__Jointposeeuler__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rm_ros_interfaces__msg__Jointposeeuler__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rm_ros_interfaces__msg__Jointposeeuler__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rm_ros_interfaces__msg__Jointposeeuler);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rm_ros_interfaces__msg__Jointposeeuler * data =
      (rm_ros_interfaces__msg__Jointposeeuler *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rm_ros_interfaces__msg__Jointposeeuler__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rm_ros_interfaces__msg__Jointposeeuler__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rm_ros_interfaces__msg__Jointposeeuler__copy(
