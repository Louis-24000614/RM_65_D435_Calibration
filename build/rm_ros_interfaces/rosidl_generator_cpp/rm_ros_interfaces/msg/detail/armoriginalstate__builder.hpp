...
class Init_Armoriginalstate_err_len
{
public:
  explicit Init_Armoriginalstate_err_len(::rm_ros_interfaces::msg::Armoriginalstate & msg)
  : msg_(msg)
  {}
  Init_Armoriginalstate_dof err_len(::rm_ros_interfaces::msg::Armoriginalstate::_err_len_type arg)
  {
...
class Init_Armoriginalstate_err
{
public:
  explicit Init_Armoriginalstate_err(::rm_ros_interfaces::msg::Armoriginalstate & msg)
  : msg_(msg)
  {}
  Init_Armoriginalstate_err_len err(::rm_ros_interfaces::msg::Armoriginalstate::_err_type arg)
  {
    msg_.err = std::move(arg);
    return Init_Armoriginalstate_err_len(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_Armoriginalstate_err pose(::rm_ros_interfaces::msg::Armoriginalstate::_pose_type arg)
  {
    msg_.pose = std::move(arg);
    return Init_Armoriginalstate_err(msg_);
  }
