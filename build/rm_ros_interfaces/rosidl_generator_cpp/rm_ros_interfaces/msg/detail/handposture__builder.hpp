...
class Init_Handposture_timeout
{
public:
  explicit Init_Handposture_timeout(::rm_ros_interfaces::msg::Handposture & msg)
  : msg_(msg)
  {}
  ::rm_ros_interfaces::msg::Handposture timeout(::rm_ros_interfaces::msg::Handposture::_timeout_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_Handposture_timeout block(::rm_ros_interfaces::msg::Handposture::_block_type arg)
  {
    msg_.block = std::move(arg);
    return Init_Handposture_timeout(msg_);
  }
