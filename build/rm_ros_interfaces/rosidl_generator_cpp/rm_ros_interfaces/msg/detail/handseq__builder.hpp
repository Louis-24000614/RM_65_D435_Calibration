...
class Init_Handseq_timeout
{
public:
  explicit Init_Handseq_timeout(::rm_ros_interfaces::msg::Handseq & msg)
  : msg_(msg)
  {}
  ::rm_ros_interfaces::msg::Handseq timeout(::rm_ros_interfaces::msg::Handseq::_timeout_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_Handseq_timeout block(::rm_ros_interfaces::msg::Handseq::_block_type arg)
  {
    msg_.block = std::move(arg);
    return Init_Handseq_timeout(msg_);
  }
