  ...
  std::ostream & out)
{
  ...
  {
    out << "aloha_state_enable: ";
    rosidl_generator_traits::value_to_yaml(msg.aloha_state_enable, out);
    out << ", ";
  }

  // member: arm_current_status_enable
  {
    out << "arm_current_status_enable: ";
    rosidl_generator_traits::value_to_yaml(msg.arm_current_status_enable, out);
    out << ", ";
  }

  // member: expand_state_enable
  {
    out << "expand_state_enable: ";
    rosidl_generator_traits::value_to_yaml(msg.expand_state_enable, out);
    out << ", ";
  }
  ...
  {
    out << "joint_speed_enable: ";
    rosidl_generator_traits::value_to_yaml(msg.joint_speed_enable, out);
    out << ", ";
  }

  // member: lift_state_enable
  {
    out << "lift_state_enable: ";
    rosidl_generator_traits::value_to_yaml(msg.lift_state_enable, out);
    out << ", ";
  }

  // member: plus_base_enable
  {
    out << "plus_base_enable: ";
    rosidl_generator_traits::value_to_yaml(msg.plus_base_enable, out);
    out << ", ";
  }

  // member: plus_state_enable
  {
    out << "plus_state_enable: ";
    rosidl_generator_traits::value_to_yaml(msg.plus_state_enable, out);
  }
  out << "}";
