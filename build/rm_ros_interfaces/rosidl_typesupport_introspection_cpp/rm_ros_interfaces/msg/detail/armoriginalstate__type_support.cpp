...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Armoriginalstate_message_member_array[5] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_ros_interfaces::msg::Armoriginalstate, err),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_ros_interfaces::msg::Armoriginalstate, err_len),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
