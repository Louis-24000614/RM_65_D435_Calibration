...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Handposture_message_member_array[3] = {
  {
    "posture_num",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_ros_interfaces::msg::Handposture, timeout),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
