...
{
  new (message_memory) rm_ros_interfaces::msg::Stop(_init);
}

void Stop_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rm_ros_interfaces::msg::Stop *>(message_memory);
  typed_message->~Stop();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Stop_message_member_array[1] = {
  {
    "state",  // name
    ...
    offsetof(rm_ros_interfaces::msg::Stop, state),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Stop_message_members = {
  ...
  "Stop",  // message name
  1,  // number of fields
  sizeof(rm_ros_interfaces::msg::Stop),
...
{
  return &::rm_ros_interfaces::msg::rosidl_typesupport_introspection_cpp::Stop_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rm_ros_interfaces, msg, Stop)() {
  return &::rm_ros_interfaces::msg::rosidl_typesupport_introspection_cpp::Stop_message_type_support_handle;
}
