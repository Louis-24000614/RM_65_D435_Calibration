...
static const _Rmplusstate_type_support_symbol_names_t _Rmplusstate_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_ros_interfaces, msg, Rmplusstate)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rm_ros_interfaces, msg, Rmplusstate)),
  }
};
...
{
  return &::rm_ros_interfaces::msg::rosidl_typesupport_cpp::Rmplusstate_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rm_ros_interfaces, msg, Rmplusstate)() {
  return get_message_type_support_handle<rm_ros_interfaces::msg::Rmplusstate>();
}
