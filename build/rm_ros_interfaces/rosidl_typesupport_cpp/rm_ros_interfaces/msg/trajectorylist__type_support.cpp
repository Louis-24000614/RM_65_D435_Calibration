...
static const _Trajectorylist_type_support_symbol_names_t _Trajectorylist_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_ros_interfaces, msg, Trajectorylist)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rm_ros_interfaces, msg, Trajectorylist)),
  }
};
...
{
  return &::rm_ros_interfaces::msg::rosidl_typesupport_cpp::Trajectorylist_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rm_ros_interfaces, msg, Trajectorylist)() {
  return get_message_type_support_handle<rm_ros_interfaces::msg::Trajectorylist>();
}
