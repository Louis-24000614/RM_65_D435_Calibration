...
static const _Modbustcpmasterinfo_type_support_symbol_names_t _Modbustcpmasterinfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_ros_interfaces, msg, Modbustcpmasterinfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rm_ros_interfaces, msg, Modbustcpmasterinfo)),
  }
};
...
{
  return &::rm_ros_interfaces::msg::rosidl_typesupport_cpp::Modbustcpmasterinfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rm_ros_interfaces, msg, Modbustcpmasterinfo)() {
  return get_message_type_support_handle<rm_ros_interfaces::msg::Modbustcpmasterinfo>();
}
