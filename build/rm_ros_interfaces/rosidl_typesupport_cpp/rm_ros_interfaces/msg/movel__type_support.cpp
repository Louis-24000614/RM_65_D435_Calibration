...
static const _Movel_type_support_symbol_names_t _Movel_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_ros_interfaces, msg, Movel)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rm_ros_interfaces, msg, Movel)),
  }
};
...
get_message_type_support_handle<rm_ros_interfaces::msg::Movel>()
{
  return &::rm_ros_interfaces::msg::rosidl_typesupport_cpp::Movel_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rm_ros_interfaces, msg, Movel)() {
  return get_message_type_support_handle<rm_ros_interfaces::msg::Movel>();
}
