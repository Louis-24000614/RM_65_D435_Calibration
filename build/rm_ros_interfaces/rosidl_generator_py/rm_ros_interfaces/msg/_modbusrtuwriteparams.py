...
class Metaclass_Modbusrtuwriteparams(type):
    """Metaclass of message 'Modbusrtuwriteparams'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'rm_ros_interfaces.msg.Modbusrtuwriteparams')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__modbusrtuwriteparams
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__modbusrtuwriteparams
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__modbusrtuwriteparams
            cls._TYPE_SUPPORT = module.type_support_msg__msg__modbusrtuwriteparams
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__modbusrtuwriteparams
...
class Modbusrtuwriteparams(metaclass=Metaclass_Modbusrtuwriteparams):
    """Message class 'Modbusrtuwriteparams'."""
    ...
    def device(self, value):
        if __debug__:
            ...
            assert value >= -2147483648 and value < 2147483648, \
                "The 'device' field must be an integer in [-2147483648, 2147483647]"
        self._device = value
