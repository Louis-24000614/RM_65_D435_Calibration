...
bool rm_ros_interfaces__msg__modbustcpmasterinfo__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rm_ros_interfaces.msg._modbustcpmasterinfo.Modbustcpmasterinfo", full_classname_dest, 62) == 0);
  }
  rm_ros_interfaces__msg__Modbustcpmasterinfo * ros_message = _ros_message;
  {  // master_name
...
{
  /* NOTE(esteve): Call constructor of Modbustcpmasterinfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rm_ros_interfaces.msg._modbustcpmasterinfo");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Modbustcpmasterinfo");
