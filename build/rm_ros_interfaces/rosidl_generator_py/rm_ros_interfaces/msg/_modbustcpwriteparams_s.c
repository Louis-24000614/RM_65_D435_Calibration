...
bool rm_ros_interfaces__msg__modbustcpwriteparams__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rm_ros_interfaces.msg._modbustcpwriteparams.Modbustcpwriteparams", full_classname_dest, 64) == 0);
  }
  rm_ros_interfaces__msg__Modbustcpwriteparams * ros_message = _ros_message;
  {  // address
...
{
  /* NOTE(esteve): Call constructor of Modbustcpwriteparams */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rm_ros_interfaces.msg._modbustcpwriteparams");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Modbustcpwriteparams");
