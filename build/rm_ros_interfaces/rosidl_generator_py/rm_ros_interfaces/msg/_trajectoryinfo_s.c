...
bool rm_ros_interfaces__msg__trajectoryinfo__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rm_ros_interfaces.msg._trajectoryinfo.Trajectoryinfo", full_classname_dest, 52) == 0);
  }
  rm_ros_interfaces__msg__Trajectoryinfo * ros_message = _ros_message;
  {  // name
  ...
  {  // create_time
    ...
    rosidl_runtime_c__String__assign(&ros_message->create_time, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // point_num
...
{
  /* NOTE(esteve): Call constructor of Trajectoryinfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rm_ros_interfaces.msg._trajectoryinfo");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Trajectoryinfo");
  ...
  {  // create_time
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->create_time.data,
      strlen(ros_message->create_time.data),
      "replace");
    if (!field) {
      return NULL;
    }
