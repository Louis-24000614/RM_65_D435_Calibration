...
class Metaclass_Getmodbustcpmasterlist(type):
    """Metaclass of message 'Getmodbustcpmasterlist'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'rm_ros_interfaces.msg.Getmodbustcpmasterlist')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__getmodbustcpmasterlist
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__getmodbustcpmasterlist
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__getmodbustcpmasterlist
            cls._TYPE_SUPPORT = module.type_support_msg__msg__getmodbustcpmasterlist
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__getmodbustcpmasterlist
...
class Getmodbustcpmasterlist(metaclass=Metaclass_Getmodbustcpmasterlist):
    """Message class 'Getmodbustcpmasterlist'."""
