...
bool rm_ros_interfaces__msg__modbusrtuwriteparams__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rm_ros_interfaces.msg._modbusrtuwriteparams.Modbusrtuwriteparams", full_classname_dest, 64) == 0);
  }
  rm_ros_interfaces__msg__Modbusrtuwriteparams * ros_message = _ros_message;
  {  // address
...
{
  /* NOTE(esteve): Call constructor of Modbusrtuwriteparams */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rm_ros_interfaces.msg._modbusrtuwriteparams");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Modbusrtuwriteparams");
