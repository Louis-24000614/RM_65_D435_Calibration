...
bool rm_ros_interfaces__msg__setforceposition__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rm_ros_interfaces.msg._setforceposition.Setforceposition", full_classname_dest, 56) == 0);
  }
  rm_ros_interfaces__msg__Setforceposition * ros_message = _ros_message;
  {  // sensor
...
{
  /* NOTE(esteve): Call constructor of Setforceposition */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rm_ros_interfaces.msg._setforceposition");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Setforceposition");
