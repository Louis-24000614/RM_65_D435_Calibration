...
#include "rm_ros_interfaces/msg/detail/armstate__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rm_ros_interfaces::msg::Armstate & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rm_ros_interfaces::msg::Armstate & ros_message)
{
  // Member: joint
  {
    cdr >> ros_message.joint;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_ros_interfaces::msg::Armstate;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rm_ros_interfaces::msg::Armstate *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rm_ros_interfaces::msg::Armstate *>(
    untyped_ros_message);
...
{
  return &rm_ros_interfaces::msg::typesupport_fastrtps_cpp::_Armstate__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_ros_interfaces, msg, Armstate)() {
  return &rm_ros_interfaces::msg::typesupport_fastrtps_cpp::_Armstate__handle;
}
