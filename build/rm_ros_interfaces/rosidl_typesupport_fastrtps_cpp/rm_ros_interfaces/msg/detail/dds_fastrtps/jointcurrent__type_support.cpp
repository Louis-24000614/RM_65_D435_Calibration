...
#include "rm_ros_interfaces/msg/detail/jointcurrent__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rm_ros_interfaces::msg::Jointcurrent & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: joint_current
  {
    cdr << ros_message.joint_current;
  }
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rm_ros_interfaces::msg::Jointcurrent & ros_message)
{
  // Member: joint_current
  {
    cdr >> ros_message.joint_current;
  ...
  size_t current_alignment)
{
  ...
  // Member: joint_current
  {
    ...
    size_t item_size = sizeof(ros_message.joint_current[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_ros_interfaces::msg::Jointcurrent;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rm_ros_interfaces::msg::Jointcurrent *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rm_ros_interfaces::msg::Jointcurrent *>(
    untyped_ros_message);
...
{
  return &rm_ros_interfaces::msg::typesupport_fastrtps_cpp::_Jointcurrent__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_ros_interfaces, msg, Jointcurrent)() {
  return &rm_ros_interfaces::msg::typesupport_fastrtps_cpp::_Jointcurrent__handle;
}
