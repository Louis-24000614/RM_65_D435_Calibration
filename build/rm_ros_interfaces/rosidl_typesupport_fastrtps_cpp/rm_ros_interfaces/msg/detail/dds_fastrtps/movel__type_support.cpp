...
#include "rm_ros_interfaces/msg/detail/movel__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rm_ros_interfaces::msg::Movel & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rm_ros_interfaces::msg::Movel & ros_message)
{
  // Member: pose
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_ros_interfaces::msg::Movel;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rm_ros_interfaces::msg::Movel *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rm_ros_interfaces::msg::Movel *>(
    untyped_ros_message);
...
{
  return &rm_ros_interfaces::msg::typesupport_fastrtps_cpp::_Movel__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_ros_interfaces, msg, Movel)() {
  return &rm_ros_interfaces::msg::typesupport_fastrtps_cpp::_Movel__handle;
}
